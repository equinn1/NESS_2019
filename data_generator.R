...
fname = paste("/home/gquinn/Desktop/html/stonehill/math/stan/v19/cmdstan/examples/irt",
              '/data_',I,'_',J,'_',K,'.R',sep='')
fname

dump(c("I","J","K","N","LKJ_eta1","LKJ_eta2","y","ii","jj","kk"),file=fname)
